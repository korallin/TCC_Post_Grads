...
def update_datatable(ano_escolhido, vara_escolhida):
    ...
    dados_analise_estatistica = pd.DataFrame({
                     ...
                     "Assunto - jan": pd.Series(janeiro_acima_media_lista),
                     "total - jan": pd.Series(janeiro_anomalia_lista),
                     "Assunto - fev": pd.Series(fevereiro_acima_media_lista),
                     "total - fev": pd.Series(fevereiro_anomalia_lista),
                     "Assunto - mar:": pd.Series(marco_acima_media_lista),
                     "total - mar": pd.Series(marco_anomalia_lista),
                     "Assunto - abr": pd.Series(abril_acima_media_lista),
                     "total - abr": pd.Series(abril_anomalia_lista),
                     "Assunto - mai": pd.Series(maio_acima_media_lista),
                     "total - mai": pd.Series(maio_anomalia_lista),
                     "Assunto - jun": pd.Series(junho_acima_media_lista),
                     "total - jun": pd.Series(junho_anomalia_lista),
                     "Assunto - jul": pd.Series(julho_acima_media_lista),
                     "total - jul": pd.Series(julho_anomalia_lista),
                     "Assunto - ago": pd.Series(agosto_acima_media_lista),
                     "total - ago": pd.Series(agosto_anomalia_lista),
                     "Assunto - set:":pd.Series(setembro_acima_media_lista),
                     "total - set": pd.Series(setembro_anomalia_lista),
                     "Assunto - out": pd.Series(outubro_acima_media_lista),
                     "total - out": pd.Series(outubro_anomalia_lista),
                     "Assunto - nov": pd.Series(novembro_acima_media_lista),
                     "total - nov": pd.Series(novembro_anomalia_lista),
                     "Assunto - dez": pd.Series(dezembro_acima_media_lista),
    ...
    columns=[
        {"name": ["Janeiro", "Assunto - jan"], "id": "janeiro"},
        {"name": ["Janeiro", "total - jan"], "id": "jan"},
        {"name": ["Fevereiro", "Assunto - fev"], "id": "fevereiro"},
        {"name": ["Fevereiro", "total - fev"], "id": "fev"},
        {"name": ["Março", "Assunto - mar"], "id": "marco"},
        {"name": ["Março", "total - mar"], "id": "mar"},
        {"name": ["Abril", "Assunto - abr"], "id": "abril"},
        {"name": ["Abril", "total - abr"], "id": "abr"},
        {"name": ["Maio", "Assunto - mai"], "id": "maio"},
        {"name": ["Maio", "total - mai"], "id": "mai"},
        {"name": ["Junho", "Assunto - jun"], "id": "junho"},
        {"name": ["Junho", "total - jun"], "id": "jun"},
        {"name": ["Julho", "Assunto - jul"], "id": "julho"},
        {"name": ["Julho", "total - jul"], "id": "jul"},
        {"name": ["Agosto", "Assunto - ago"], "id": "agosto"},
        {"name": ["Agosto", "total - ago"], "id": "ago"},
        {"name": ["Setembro", "Assunto - set"], "id": "setembro"},
        {"name": ["Setembro", "total - set"], "id": "set"},
        {"name": ["Outubro", "Assunto - out"], "id": "outubro"},
        {"name": ["Outubro", "total - out"], "id": "out"},
        {"name": ["Novembro", "Assunto - nov"], "id": "novembro"},
        {"name": ["Novembro", "total - nov"], "id": "nov"},
        {"name": ["Dezembro", "Assunto - dez"], "id": "dezembro"},
        {"name": ["Dezembro", "total - dez"], "id": "dez"},
    ]

    style_data_conditional=[
        {
            'if': {
                'filter_query': '{{total - jan}} > {}'.format(anomalia_ano),
                'column_id': 'jan'
            },
        ...
        {
            'if': {
                'filter_query': '{{total - fev}} > {}'.format(anomalia_ano),
                'column_id': 'fev'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - mar}} > {}'.format(anomalia_ano),
                'column_id': 'mar'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - abr}} > {}'.format(anomalia_ano),
                'column_id': 'abr'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - mai}} > {}'.format(anomalia_ano),
                'column_id': 'mai'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - jun}} > {}'.format(anomalia_ano),
                'column_id': 'jun'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - jul}} > {}'.format(anomalia_ano),
                'column_id': 'jul'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - ago}} > {}'.format(anomalia_ano),
                'column_id': 'ago'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - set}} > {}'.format(anomalia_ano),
                'column_id': 'set'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - out}} > {}'.format(anomalia_ano),
                'column_id': 'out'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - nov}} > {}'.format(anomalia_ano),
                'column_id': 'nov'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
        ...
        {
            'if': {
                'filter_query': '{{total - dez}} > {}'.format(anomalia_ano),
                'column_id': 'dez'
            },
            'backgroundColor': '#FF4136',
            'color': 'white',
    ...
    return (html.H3('Tabela com as maiores demandas da {}, detalhadas por mês, no ano {}:'.format(vara_escolhida,ano_escolhido), style=TEXT_STYLE),
