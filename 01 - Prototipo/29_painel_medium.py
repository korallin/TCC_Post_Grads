...
def update_datatable(ano_escolhido, vara_escolhida):
    ...
    dados_analise_estatistica = pd.DataFrame({
                     ...
                     "Janeiro - acima da média": pd.Series(janeiro_acima_media_lista),
                     "Janeiro - muito acima da média": pd.Series(janeiro_anomalia_lista),
                     "Fevereiro - acima da média": pd.Series(fevereiro_acima_media_lista),
                     "Fevereiro - muito acima da média": pd.Series(fevereiro_anomalia_lista),
                     "Março - acima da média": pd.Series(marco_acima_media_lista),
                     "Março - muito acima da média": pd.Series(marco_anomalia_lista),
                     "Abril - acima da média": pd.Series(abril_acima_media_lista),
                     "Abril - muito acima da média": pd.Series(abril_anomalia_lista),
                     "Maio - acima da média": pd.Series(maio_acima_media_lista),
                     "Maio - muito acima da média": pd.Series(maio_anomalia_lista),
                     "Junho - acima da média": pd.Series(junho_acima_media_lista),
                     "Junho - muito acima da média": pd.Series(junho_anomalia_lista),
                     "Julho - acima da média": pd.Series(julho_acima_media_lista),
                     "Julho - muito acima da média": pd.Series(julho_anomalia_lista),
                     "Agosto - acima da média": pd.Series(agosto_acima_media_lista),
                     "Agosto - muito acima da média": pd.Series(agosto_anomalia_lista),
                     "Setembro - acima da média":pd.Series(setembro_acima_media_lista),
                     "Setembro - muito acima da média": pd.Series(setembro_anomalia_lista),
                     "Outubro - acima da média": pd.Series(outubro_acima_media_lista),
                     "Outubro - muito acima da média": pd.Series(outubro_anomalia_lista),
                     "Novembro - acima da média": pd.Series(novembro_acima_media_lista),
                     "Novembro - muito acima da média": pd.Series(novembro_anomalia_lista),
                     "Dezembro - acima da média": pd.Series(dezembro_acima_media_lista),
                     "Dezembro - muito acima da média": pd.Series(dezembro_anomalia_lista)
